...
describe('Validator', () => {
    ...
    it('rules', () => {
        ...
        assert.instanceOf(validator.floatVal(), Validator);
        assert.instanceOf(validator.functionInstance(), Validator);
        assert.instanceOf(validator.functionType(), Validator);
        ...
        assert.instanceOf(validator.intVal(), Validator);
        assert.instanceOf(validator.json(), Validator);
        assert.instanceOf(validator.lowercase(), Validator);
        assert.instanceOf(validator.multiple(0), Validator);
        assert.instanceOf(validator.negative(), Validator);
        assert.instanceOf(validator.no(), Validator);
        assert.instanceOf(validator.not(validator.alwaysInvalid()), Validator);
        assert.instanceOf(validator.nullType(), Validator);
        assert.instanceOf(validator.numberInstance(), Validator);
        ...
        assert.instanceOf(validator.regexVal(), Validator);
        ...
        assert.instanceOf(validator.when(
