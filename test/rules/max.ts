...
describe('Max', () => {
    ...
    it('values is valid', () => {
        ...
        assert.isTrue(new Max('abc', false).validate('ab'));
        ...
        assert.isTrue(new Max('20b').validate('10b'));
        assert.isTrue(new Max('20mb').validate('10mb'));
    });
    ...
    it('values is not valid', () => {
        ...
        assert.isFalse(new Max('ab').validate('abc'));
        ...
        assert.isFalse(new Max('5b').validate('10b'));
        assert.isFalse(new Max('5b').validate('10mb'));
    });
